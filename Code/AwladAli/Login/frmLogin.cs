    ...
    public partial class frmLogin : Form
    {
        ...
        private void btnLogin_Click(object sender, EventArgs e)
        {
            ...
            if (user != null && user.IsActive)
            {
                ...
                // 4. Success Logic (Meticulously configured for the master Program lifecycle loop architecture)
                clsGlobal.CurrentUser = user;
                
                // 🎯 CRITICAL FIX: Set DialogResult to OK to hand over control to Program.cs seamlessly
                this.DialogResult = DialogResult.OK;

                // 🎯 CRITICAL FIX: Cleanly close this dialog instance to let the loop kick-off frmMain execution
                this.Close(); 
            }
            else
            {
